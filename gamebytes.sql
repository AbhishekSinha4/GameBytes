...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 01, 2018 at 06:42 PM
...
CREATE TABLE `bookings` (
  ...
  `book_timestart` time(5) DEFAULT NULL,
  `book_timeend` time(5) DEFAULT NULL
...
INSERT INTO `game_console` (`g_id`, `c_id`) VALUES
('BF1', 'PS4'),
('BF4', 'PS4'),
('BFH', 'PC'),
('BFH', 'PS4'),
...
('L01', 'Rogue Games', '14, 2nd B Main, 2nd Stage, Peenya', '560011', ''),
('L02', 'Karma Games', '483, 3, Beml Layt, Rajarajeshwari Nagar', '560001', ''),
('L03', 'Abacus Games', '6, M S Ramarah Industrial Estate, Mathikere', '560054', ''),
('L04', 'The Vineyard', '10, 2 A Cross, 1st Main, 1st Stage, Baseveshwara Nagar', '560079', ''),
('L05', 'Nova Games', '71/7, Kanakapura Main Road, Jaraganahalli, JP Nagar', '560078', ''),
('L06', 'The Sapphire', '4, Edgha Bld, B S A Road, Tannery Road', '560005', ''),
...
('L14', 'Purity Games', '13/20, New Galic Complex, Apmc Yard, Yeshwanthpur', '560012', ''),
('L15', 'Sunset Games', '16, NGV, Koramangla', '560014', ''),
('L16', 'The Brimst', '100/1, Arabic College Mn Rd, Opp Bilal Cplx, Venka', '560011', ''),
('L17', 'The Origin', '31, 4th Main, Chamarajpet', '560018', ''),
('L18', 'The Cool Club', '11, 5th Main Road, Indiranagar', '560071', ''),
('L19', 'City Plaza', '#22, 12th Main, Indiranagar', '560055', ''),
('L20', 'The Pepper', '#3, Puttenhalli, JP Nagar', '560078', ''),
('L21', 'Basil Games', '75, 6th Cross, RR Nagar', '560071', ''),
('L22', 'The Emperor Games', '654/3d, Thangiamma Rd, R S Palya, Kanakapura', '560011', ''),
('L23', 'Starlight ', 'Hotelmaurya, Race Course Road', '560089', ''),
('L24', 'The Lamb Games', '28/29, Mallasandra', '560007', ''),
('L25', 'Shambles Games', '9, GC Esquire Center, MG Road', '560001', '');
...
('M01', 'hello123', '0987654321', 'Aditya', 'Pandey', 'RR Nagar', '2018-02-01', '2019-02-01', ''),
...
('M34', 'hello123', '9876543210', 'Abhishek', 'Sinha', 'Banashankari', '2018-04-24', '2018-04-25', ''),
('M35', 'hello123', '1234567890', 'abhi', 'shek', 'pesu', '2018-04-24', '2018-04-25', ''),
('M36', 'hello123', '3333355555', 'Aditya', 'Arora', 'Banashankari', '2018-04-24', '2018-04-25', '');
...
--
-- Indexes for table `game_console`
--
...
--
ALTER TABLE `game_console`
  ADD CONSTRAINT `game_console_ibfk_1` FOREIGN KEY (`g_id`) REFERENCES `game` (`g_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `game_console_ibfk_2` FOREIGN KEY (`c_id`) REFERENCES `console` (`c_id`) ON DELETE CASCADE ON UPDATE CASCADE;
